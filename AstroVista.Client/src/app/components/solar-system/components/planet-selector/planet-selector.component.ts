...
@Component({
  ...
  template: `
    ...
    @if (isOpen) {
      <div
        class="absolute top-16 left-5 bg-ebony-950/90 border border-ebony-700/30 rounded-lg p-2 text-ebony-50 backdrop-blur-md z-20 shadow-lg max-h-[70vh] overflow-y-auto"
      >
